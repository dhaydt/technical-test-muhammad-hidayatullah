...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="{{ asset('land/css/bootstrap.css') }}">
    <!-- Magnific Popup -->
    <link rel="stylesheet" href="{{ asset('land/css/magnific-popup.min.css') }}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('land/css/font-awesome.css') }}">
    <!-- Fancybox -->
    <link rel="stylesheet" href="{{ asset('land/css/jquery.fancybox.min.css') }}">
    <!-- Themify Icons -->
    <link rel="stylesheet" href="{{ asset('land/css/themify-icons.css')}}">
    <!-- Nice Select CSS -->
    <link rel="stylesheet" href="{{ asset('land/css/niceselect.css') }}">
    <!-- Animate CSS -->
    <link rel="stylesheet" href="{{ asset('land/css/animate.css') }}">
    <!-- Flex Slider CSS -->
    <link rel="stylesheet" href="{{ asset('land/css/flex-slider.min.css')}}">
    <!-- Owl Carousel -->
    <link rel="stylesheet" href="{{ asset('land/css/owl-carousel.css') }}">
    <!-- Slicknav -->
    <link rel="stylesheet" href="{{ asset('land/css/slicknav.min.css')}}">

    <!-- Eshop StyleSheet -->
    <link rel="stylesheet" href="{{ asset('land/css/reset.css') }}">
...
<body class="js">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-12">
                        ...
                        <div class="top-left">
                            <ul class="list-main">
                                <li><i class="ti-headphone-alt"></i> +62 (823) 8285 2283</li>
                                <li><i class="ti-email"></i> 1992dayat@gmail.com</li>
                            </ul>
                        </div>
                        <!--/ End Top Left -->
                    </div>
                    <div class="col-lg-8 col-md-12 col-12">
                        ...
                        <div class="right-content">
                            <ul class="list-main">
                                ...
                                @if (Route::has('login'))
                                    @auth
                                    <li><i class="ti-power-off"></i><a href="{{ url('/home') }}">Admin Panel</a></li>
                                    @else
                                    <li><i class="ti-power-off"></i><a href="{{ route('login') }}">Login Admin</a></li>
                                    @if (Route::has('register'))
                                    <li><i class="ti-power-off"></i><a href="{{ route('register') }}">Register Admin</a></li>
                                    @endif
                                    @endauth
                                @endif
    ...
    <script src="{{ asset('land/js/jquery-migrate-3.0.0.js') }}"></script>
    <script src="{{ asset('land/js/jquery-ui.min.js') }}"></script>
    <!-- Popper JS -->
    <script src="{{ asset('land/js/popper.min.js') }}"></script>
    <!-- Bootstrap JS -->
    <script src="{{ asset('land/js/bootstrap.min.js') }}"></script>
    <!-- Color JS -->
    <script src="{{ asset('land/js/colors.js') }}"></script>
    <!-- Slicknav JS -->
    <script src="{{ asset('land/js/slicknav.min.js') }}"></script>
    <!-- Owl Carousel JS -->
    <script src="{{ asset('land/js/owl-carousel.js') }}"></script>
    <!-- Magnific Popup JS -->
    <script src="{{ asset('land/js/magnific-popup.js') }}"></script>
    <!-- Waypoints JS -->
    <script src="{{ asset('land/js/waypoints.min.js') }}"></script>
    <!-- Countdown JS -->
    <script src="{{ asset('land/js/finalcountdown.min.js') }}"></script>
    <!-- Nice Select JS -->
    <script src="{{ asset('land/js/nicesellect.js') }}"></script>
    <!-- Flex Slider JS -->
    <script src="{{ asset('land/js/flex-slider.js') }}}}"></script>
    <!-- ScrollUp JS -->
    <script src="{{ asset('land/js/scrollup.js') }}"></script>
    <!-- Onepage Nav JS -->
    <script src="{{ asset('land/js/onepage-nav.min.js') }}"></script>
    <!-- Easing JS -->
    <script src="{{ asset('land/js/easing.js') }}"></script>
    <!-- Active JS -->
    <script src="{{ asset('land/js/active.js') }}"></script>
</body>
